...
import { ChevronDown, RotateCcw, Globe, Sparkles, Receipt } from "lucide-react";
...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      {/* ── Top Section: Brand Value Badges ── */}
      <div className="bg-[#fbf1ea] py-12 sm:py-16 border-b border-[#3b2a25]/10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 text-center">
            {valueProps.map(({ icon: Icon, title, description }) => (
              <div key={title} className="flex flex-col items-center group">
                ...
                {/* Description */}
                <p className="text-xs sm:text-[13px] text-gray-600 max-w-[240px] leading-relaxed">
                  {description}
                </p>
              </div>
            ))}
